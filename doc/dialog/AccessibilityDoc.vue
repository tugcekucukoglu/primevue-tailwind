<template>
    <DocSectionText id="accessibility" label="Accessibility" v-bind="$attrs">
        ...
        <p>
            Close element is a <i>button</i> with an <i>aria-label</i> that refers to the <i>aria.close</i> property of the <a href="https://primevue.org/fileupload" target="_blank" rel="noopener noreferrer">locale</a> API by default, you may use
