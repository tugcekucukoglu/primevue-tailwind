<template>
    <DocSectionText id="accessibility" label="Accessibility" v-bind="$attrs">
        ...
        <p>
            A slide has a <i>group</i> role with an aria-label that refers to the <i>aria.slideNumber</i> property of the <NuxtLink to="/fileupload">locale</NuxtLink> API. Similarly <i>aria.slide</i> is used as the <i>aria-roledescription</i> of the
            item. Inactive slides are hidden from the readers with <i>aria-hidden</i>.
        </p>

        <p>
            Next and Previous navigators are button elements with <i>aria-label</i> attributes referring to the <i>aria.prevPageLabel</i> and <i>aria.nextPageLabel</i> properties of the <NuxtLink to="/fileupload">locale</NuxtLink> API by default
        ...
        <p>
            ...
            <i>aria-label</i> attribute of a quick navigation item refers to the <i>aria.pageLabel</i> of the <NuxtLink to="/fileupload">locale</NuxtLink> API. Current page is marked with <i>aria-current</i>.
        </p>

        <p>In full screen mode, modal element uses <i>dialog</i> role with <i>aria-modal</i> enabled. The close button retrieves <i>aria-label</i> from the <i>aria.close</i> property of the <NuxtLink to="/fileupload">locale</NuxtLink> API.</p>
