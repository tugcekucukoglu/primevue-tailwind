<template>
    <DocSectionText id="accessibility" label="Accessibility" v-bind="$attrs">
        ...
        <p>Quick navigation elements are button elements with an <i>aria-label</i> attribute referring to the <i>aria.pageLabel</i> of the <NuxtLink to="/fileupload">locale</NuxtLink> API. Current page is marked with <i>aria-current</i>.</p>
