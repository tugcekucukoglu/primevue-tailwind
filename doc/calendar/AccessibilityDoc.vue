<template>
    <DocSectionText id="accessibility" label="Accessibility" v-bind="$attrs">
        ...
        <p>
            ...
            <i>chooseDate</i> key of the aria property from the <a href="https://primevue.org/fileupload" target="_blank" rel="noopener noreferrer">locale</a> API. This label is also used for the <i>aria-label</i> of the popup as well. When there is
            a value selected, it is formatted and appended to the label to be able to notify users about the current value.
        </p>
