<template>
    <DocSectionText id="accessibility" label="Accessibility" v-bind="$attrs">
        ...
        <p>
            Closable inplace components displays a button with an <i>aria-label</i> that refers to the <i>aria.close</i> property of the <NuxtLink to="/fileupload">locale</NuxtLink> API by default, you may use <i>closeButtonProps</i> to customize the
