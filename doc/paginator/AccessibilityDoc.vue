<template>
    <DocSectionText id="accessibility" label="Accessibility" v-bind="$attrs">
        ...
        <p>
            ...
            <a href="https://primevue.org/fileupload" target="_blank" rel="noopener noreferrer">locale</a> API respectively.
        </p>

        <p>
            Page links are also button elements with an <i>aria-label</i> attribute derived from the <i>aria.pageLabel</i> of the <a href="https://primevue.org/fileupload" target="_blank" rel="noopener noreferrer">locale</a> API. Current page is
        ...
        <p>
            ...
            <i>aria.rowsPerPageLabel</i> property of the <a href="https://primevue.org/fileupload" target="_blank" rel="noopener noreferrer">locale</a> API.
        </p>
        ...
        <p>
            ...
            the <i>aria.jumpToPageDropdownLabel</i> property of the <a href="https://primevue.org/fileupload" target="_blank" rel="noopener noreferrer">locale</a> API.
        </p>
