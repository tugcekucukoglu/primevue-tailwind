<template>
    <DocSectionText id="accessibility" label="Accessibility" v-bind="$attrs">
        ...
        <p>
            ...
            <a href="https://primevue.org/fileupload" target="_blank" rel="noopener noreferrer">locale</a> API.
        </p>

        <p>If filtering is enabled, <i>filterInputProps</i> can be defined to give <i>aria-*</i> props to the input element.</p>

        <p>
            Close button uses <i>close</i> key of the <i>aria</i> property from the <a href="https://primevue.org/fileupload" target="_blank" rel="noopener noreferrer">locale</a> API as the <i>aria-label</i> by default, this can be overriden with the
            <i>closeButtonProps</i>.
        </p>
